...
- **Связи заявок**: `/связи №` (алиасы `/матч`, `/match`) — встречные рейсы, тот же маршрут ±3 дня и другие заявки того же контакта; в админ-панели — кнопка «связи» на каждой карточке.
